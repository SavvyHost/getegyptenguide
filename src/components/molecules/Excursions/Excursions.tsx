        ...
        <div className="relative aspect-[4/3] w-full overflow-hidden">
          ...
          >
            {isInWishlist(id) ? (
              ...
              <FaRegHeart className="text-primary-dark w-5 h-5" />
            )}
          </button>
        </div>

        <div className="p-4">
          <div className="flex items-center gap-1.5 text-sm text-primary-dark mb-2">
          ...
          <div>
            <div className="text-sm">
              <span className="line-through text-primary-dark">
                From ${price + 20}
              </span>
            </div>
            <div className="flex items-baseline gap-1 mt-1">
              ...
              <span className="text-sm text-primary-dark">/ Person</span>
            </div>
          </div>
        </div>
      </div>
