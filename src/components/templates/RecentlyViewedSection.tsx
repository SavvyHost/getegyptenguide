              ...
              <div key={item.id} className="px-2 pb-4" data-index={index}>
                ...
                >
                  <div className="relative">
                    ...
                    {item.isFeatured && (
                      <div className="absolute top-4 left-4">
                        <span className="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-medium bg-green-600 text-white shadow-lg">
                          Featured
                        </span>
                      </div>
                    )}
                  ...
                  <div className="p-5">
                    ...
                    <h3 className="text-lg font-semibold mb-3 text-gray-900 group-hover:text-green-600 transition-colors line-clamp-2">
                      {item.title}
                    </h3>
                    ...
                    <div className="border-t pt-4">
                      <div className="flex items-center justify-between">
                        ...
                        <Link
                          ...
                          className="px-4 py-2 bg-primary-light text-white rounded-lg hover:bg-accent-yellow transition-colors text-sm font-medium"
                        >
                          View Details
                        </Link>
                      </div>
