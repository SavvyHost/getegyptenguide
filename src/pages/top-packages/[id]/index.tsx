    ...
    <>
      ...
      {isMounted && (
        <>
          ...
          <div
            className={`hidden lg:flex z-[999] fixed bottom-0 w-full bg-white py-4 px-8 items-center justify-center gap-6 border-t border-gray-200 transition-all duration-300
        before:content-[''] before:absolute before:top-0 before:left-0 before:right-0 before:h-6 before:-translate-y-full
        before:bg-gradient-to-t before:from-black/10 before:to-transparent before:pointer-events-none
        ...
        ${
          ...
          >
            <button
              onClick={scrollToTop}
              className="lg:text-xl text-lg font-extrabold text-primary-light hover:text-green-700 transition duration-200 underline ml-4"
            >
              Book Now
            </button>
            ...
            <div className="text-xl font-normal">
              Price Start From{" "}
              <span className="text-2xl ml-3 underline font-semibold text-primary-light min-w-[80px] text-center">
