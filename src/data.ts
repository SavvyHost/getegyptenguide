...
export const sampleExcursions = [
  {
    imageSrc: Egy,
    location: "Cairo, Egypt",
    title: "Wadi Elrayan, small group to Luxor, Valley of the king.",
  ...
  },
  {
    imageSrc: Egy,
    location: "Giza, Egypt",
    title: "Pyramids of Giza and Sphinx: Half-Day Private Tour",
    pickupAvailable: true,
    rating: 4.8,
    reviewCount: 2500,
    price: 45,
  },
  {
    imageSrc: Egy,
    location: "Aswan, Egypt",
    title: "Philae Temple Sound and Light Show with Private Transport",
    pickupAvailable: true,
    rating: 4.3,
    reviewCount: 800,
    price: 55,
  ...
  export const itineraryItems = [
    {
      ...
      duration: "90 minutes • Admission Ticket Free",
    },
    {
      day: "Day 2: French Quarter",
      description:
        "Your local guide will share dark, mysterious stories and legends about these French Quarter haunts, some of which involve voodoo, witchcraft, ghosts and vampires!",
      duration: "90 minutes • Admission Ticket Free",
    },
    {
      day: "Day 3: French Quarter",
      description:
        "Your local guide will share dark, mysterious stories and legends about these French Quarter haunts, some of which involve voodoo, witchcraft, ghosts and vampires!",
      duration: "90 minutes • Admission Ticket Free",
    },
    {
      day: "Day 4: French Quarter",
      description:
        "Your local guide will share dark, mysterious stories and legends about these French Quarter haunts, some of which involve voodoo, witchcraft, ghosts and vampires!",
      duration: "90 minutes • Admission Ticket Free",
    },
    {
      day: "Day 5: French Quarter",
      description:
        "Your local guide will share dark, mysterious stories and legends about these French Quarter haunts, some of which involve voodoo, witchcraft, ghosts and vampires!",
      duration: "90 minutes • Admission Ticket Free",
    },
...
export const TheexcursionDataBlogs = [
  {
    id: 1,
    image: First,
    location: "Alexandria, Egypt",
